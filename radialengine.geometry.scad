...
function calculateRadialEngineGeometry(count, center, stroke, crankShaftAngle, mainRodLength, subRodLength) =
    let (cylinderAxisAngles = [ for (i = [0 : 1 : count-1]) i * 360 / count ])
